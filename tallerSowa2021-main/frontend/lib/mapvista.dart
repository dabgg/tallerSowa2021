...
class _MapViewState extends State<MapView> {
  ...
  void updateMarker(geo.LocationData newLocalData, Uint8List imageData) {
    ...
    this.setState(() {
      ...
      marker.add(Marker(
        ...
        position: LatLng(-33.022769, -71.551526),
        infoWindow: InfoWindow(
          title: 'Puente Libertad',
          snippet: 'Altura: 0'
        ),
      ));
      marker.add(Marker(
        markerId: MarkerId("marcador3"),
        position: LatLng(-32.972405, -71.536111),
        infoWindow: InfoWindow(
          title: 'Puente Av. Gastón Hamel Nieto',
          snippet: 'Altura: 0'
        ),
      ));
      marker.add(Marker(
        markerId: MarkerId("marcador4"),
        position: LatLng(-33.045617, -71.505367),
        infoWindow: InfoWindow(
          title: 'Tunel Jardin Botanico',
          snippet: 'Altura: 0'
        ),
      ));
      circle = Circle(
  ...
  void getCurrentLocationCar() async {
    try {
      ...
      _tracker.changeSettings(distanceFilter: 100);
